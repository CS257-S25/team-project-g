...
class TestSearchFunctions(unittest.TestCase):
    def test_search_genre_horror(self):
        ...
        expected = [
            ...
            "Kill or be Killed, Vol. 1 by Elizabeth Breitweiser, Sean Phillips, Ed Brubaker (ISBN: 1534300287)",
            "Kill or be Killed, Vol. 2 by Elizabeth Breitweiser, Sean Phillips, Ed Brubaker (ISBN: 153430228X)",
